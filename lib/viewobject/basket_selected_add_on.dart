...
class BasketSelectedAddOn extends PsObject<BasketSelectedAddOn> {
  BasketSelectedAddOn(
      {this.id, this.name, this.price, this.currencySymbol});
  ...
  final List<BasketSelectedAddOn> _selectedAddOnList =
      <BasketSelectedAddOn>[];
  ...
  void addAddOn(BasketSelectedAddOn basketSelectedaddOn) {
    if (_selectedAddOnList.isEmpty) {
      ...
      for (int i = 0; i < _selectedAddOnList.length; i++) {
        if (_selectedAddOnList[i].id ==
            basketSelectedaddOn.id) {
          isNew = false;
          index = i;
          break;
        }
  ...
  List<BasketSelectedAddOn> fromMapList(List<dynamic>? dynamicDataList) {
    final List<BasketSelectedAddOn> userLoginList =
        <BasketSelectedAddOn>[];
