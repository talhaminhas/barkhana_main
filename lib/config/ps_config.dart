...
class PsConfig {
  ...
  ///
  static const String app_version = '2.7';
  ...
  //'http://192.168.1.225:8080/Barkhana';
...
// static const ps_language_list = [Locale('en', 'US'), Locale('ar', 'DZ')];
  ...
  /// Default Location
  ///
  // static String lat = '16.7745';
  // static String lng = '96.1588';
  ...
  ///
  //static bool isFlutterWavePaySupportMultiCurrency = false;
