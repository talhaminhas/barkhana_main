...
import 'package:flutterrestaurant/provider/product/touch_count_provider.dart';
...
import 'package:flutterrestaurant/ui/product/detail/views/attributes_item_view.dart';
import 'package:flutterrestaurant/ui/product/detail/views/color_list_item_view.dart';
...
import 'package:flutterrestaurant/viewobject/holder/favourite_parameter_holder.dart';
...
class _CustomizeTileViewState extends State<CustomizeTileView> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.productDetail.customizedHeaderList != null &&
        widget.productDetail.customizedHeaderList!.isNotEmpty &&
