...
/// A simple dialog labelLarge click listener.
typedef RateMyAppDialogButtonClickListener = bool Function(
    RateMyAppDialogButton labelLarge);
...
class RateMyAppDialog extends StatelessWidget {
  ...
  /// The dialog's rate labelLarge.
  final String rateButton;

  /// The dialog's no labelLarge.
  final String noButton;

  /// The dialog's later labelLarge.
...
/// A Rate my app dialog labelLarge with a text, a validator and a callback.
abstract class _RateMyAppDialogButton extends StatelessWidget {
  /// Creates a new Rate my app labelLarge widget instance.
  ...
  /// The state validator (whether this labelLarge should have an effect).
  ...
  /// Triggered when a labelLarge has been clicked.
...
/// The Rate my app "rate" labelLarge widget.
class RateMyAppRateButton extends _RateMyAppDialogButton {
  /// Creates a new Rate my app "rate" labelLarge widget instance.
...
/// The Rate my app "later" labelLarge widget.
class RateMyAppLaterButton extends _RateMyAppDialogButton {
  /// Creates a new Rate my app "later" labelLarge widget instance.
...
/// The Rate my app "no" labelLarge widget.
class RateMyAppNoButton extends _RateMyAppDialogButton {
  /// Creates a new Rate my app "no" labelLarge widget instance.
...
/// Represents a Rate my app dialog labelLarge.
enum RateMyAppDialogButton {
  /// The "rate" labelLarge.
  rate,

  /// The "later" labelLarge.
  later,
