...
class ReservationListProvider extends PsProvider {
 ...
 late StreamSubscription<PsResource<List<Reservation>>> subscription;
late  StreamController<PsResource<List<Reservation>>> reservationListStream;
  ...
  Future<dynamic> loadReservationList(String userId) async {
    ...
    //_reservationList =
     await _repo!.getALLReservationList(
        reservationListStream,
        userId,
        limit,
        offset,
