 ...
 late StreamController<PsResource<List<TransactionHeader>>> transactionListStream;
  ...
  Future<dynamic> postTransactionSubmit(
    ...
    final TransactionSubmitMap newPost = TransactionSubmitMap(
      ...
      shippingTaxPercent: psValueHolder.shippingTaxLabel!.isEmpty
          ? '0'
          : psValueHolder.shippingTaxLabel!,
      taxPercent: psValueHolder.overAllTaxLabel!.isEmpty
          ? '0'
          : psValueHolder.overAllTaxLabel!,
      memo: memoText ,
